...
CREATE TABLE IF NOT EXISTS `achievement` (
                                             ...
                                             PRIMARY KEY (`id`),
                                             KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='成就领取mydb1记录';
...
DELETE FROM `aq_bag`;
/*!40000 ALTER TABLE `aq_bag` DISABLE KEYS */;
/*!40000 ALTER TABLE `aq_bag` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `bag` (
                                     ...
                                     PRIMARY KEY (`id`),
                                     KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='玩家背包库';
...
INSERT INTO `father` (`id`, `permission`) VALUES
                                              (2453709, '483120863'),
                                              (189696825, '0'),
                                              (291841860, '279097564'),
                                              (340998109, '0'),
                                              ...
                                              (1657258221, '0'),
                                              (1706804626, '0'),
                                              (1766026503, '278681553'),
                                              (1962552313, '731356886'),
                                              (2014598701, '278681553'),
                                              (2063765179, '0'),
                                              (2084638687, '278681553'),
                                              (2279731688, '0'),
                                              (2283781451, '0'),
                                              (2381451608, '0'),
                                              (2389404498, '0'),
                                              (2473316974, '0'),
                                              (2491253058, '0'),
                                              (2536905224, '278681553'),
                                              (2591948781, '0'),
                                              (2663615631, '0,731356886,814954948,836258851,278681553'),
                                              (2738612942, '0'),
                                              (2798736366, '0'),
                                              (2831523115, '278681553'),
                                              (2898304046, '0'),
                                              (2921283710, '0'),
                                              (2972482565, '0'),
                                              (3047184708, '0'),
                                              ...
                                              (3211905721, '0'),
                                              (3246972559, '0'),
                                              (3289676297, '278681553'),
                                              (3346155062, '0'),
                                              (3474006766, '836258851,278681553'),
                                              (3479046766, '0'),
                                              (3500334917, '822938413'),
                                              (3609363018, '0');
...
DELETE FROM `group_conf`;
/*!40000 ALTER TABLE `group_conf` DISABLE KEYS */;
/*!40000 ALTER TABLE `group_conf` ENABLE KEYS */;
...
DELETE FROM `g_info`;
/*!40000 ALTER TABLE `g_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `g_info` ENABLE KEYS */;
...
DELETE FROM `hhpz`;
/*!40000 ALTER TABLE `hhpz` DISABLE KEYS */;
/*!40000 ALTER TABLE `hhpz` ENABLE KEYS */;
...
DELETE FROM `killc`;
/*!40000 ALTER TABLE `killc` DISABLE KEYS */;
/*!40000 ALTER TABLE `killc` ENABLE KEYS */;
...
DELETE FROM `soul_attribute`;
/*!40000 ALTER TABLE `soul_attribute` DISABLE KEYS */;
INSERT INTO `soul_attribute` (`wh`, `hp_chance`, `hl_chance`, `hj_chance`, `hp_effect`, `hl_effect`, `hj_effect`, `hide_chance`) VALUES
                                                                                                                                     (1, 0, 0, 0, 10, 10, 10, 5),
                                                                                                                                     (2, 0, 0, 0, 10, 10, 10, 0),
                                                                                                                                     (3, 0, 5, 0, 10, 15, 10, 0),
                                                                                                                                     (4, 0, 0, 5, 10, 10, 10, 0),
                                                                                                                                     ...
                                                                                                                                     (30, 0, 0, 0, 10, 10, 14, 0),
                                                                                                                                     (31, 0, 0, 0, 10, 10, 10, 0);
/*!40000 ALTER TABLE `soul_attribute` ENABLE KEYS */;
...
DELETE FROM `soul_bone`;
/*!40000 ALTER TABLE `soul_bone` DISABLE KEYS */;
/*!40000 ALTER TABLE `soul_bone` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `task_point` DISABLE KEYS */;
/*!40000 ALTER TABLE `task_point` ENABLE KEYS */;
...
DELETE FROM `upup`;
/*!40000 ALTER TABLE `upup` DISABLE KEYS */;
/*!40000 ALTER TABLE `upup` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `user_score` (
                                            ...
                                            UNIQUE KEY `who` (`who`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户积分相关信息';
...
DELETE FROM `wh_info`;
/*!40000 ALTER TABLE `wh_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `wh_info` ENABLE KEYS */;
...
DELETE FROM `zon`;
/*!40000 ALTER TABLE `zon` DISABLE KEYS */;
/*!40000 ALTER TABLE `zon` ENABLE KEYS */;
...
DELETE FROM `zong`;
/*!40000 ALTER TABLE `zong` DISABLE KEYS */;
/*!40000 ALTER TABLE `zong` ENABLE KEYS */;
