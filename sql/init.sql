...
-- 正在导出表  auto_reply 的数据：~151 rows (大约)
DELETE
FROM `auto_reply`;
...
(
  ...
  AUTO_INCREMENT = 47055
  DEFAULT CHARSET = utf8 COMMENT ='玩家背包库';

-- 正在导出表  bag 的数据：~27,183 rows (大约)
DELETE
FROM `bag`;
...
-- 正在导出表  group_conf 的数据：~9 rows (大约)
DELETE
FROM `group_conf`;
...
-- 正在导出表  person_info 的数据：~504 rows (大约)
DELETE
FROM `person_info`;
...
-- 正在导出表  shop_item 的数据：~38 rows (大约)
DELETE
FROM `shop_item`;
...
-- 正在导出表  signlist 的数据：~1,751 rows (大约)
DELETE
FROM `signlist`;
...
-- 正在导出表  skill_info 的数据：~521 rows (大约)
DELETE
FROM `skill_info`;
...
-- 正在导出表  soul_attribute 的数据：~31 rows (大约)
DELETE
FROM `soul_attribute`;
...
-- 正在导出表  soul_bone 的数据：~259 rows (大约)
DELETE
FROM `soul_bone`;
...
-- 正在导出表  task_point 的数据：~469 rows (大约)
DELETE
FROM `task_point`;
...
-- 正在导出表  trading_record 的数据：~16,958 rows (大约)
DELETE
FROM `trading_record`;
...
-- 正在导出表  user_score 的数据：~1,424 rows (大约)
DELETE
FROM `user_score`;
